...
% \setDocCurator{Patrick Ingraham}

\setDocAbstract{%
The charge of this working group is developed in response to the \href{https://jira.lsstcorp.org/browse/SITCOM-172}{Jira ticket} created as part of the Missing Capabilities workshop.\\
